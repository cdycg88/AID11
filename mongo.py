...
# myset.save({'name':'胡军','role':'萧风'})
# myset.save({'_id':1,'name':'李亚鹏','role':'萧亚轩'})
...
# for i in cursor.sort([('name',1),('rike',-1)]):
# #     print(i)
...
# myset.update({'name':'张国立'},{'$set':{'name':'张卫键','role':'韦小宝'}},multi=True)
...
# 复合操作
# print(myset.find_one_and_update({'role':'萧风'},{'$set':{'name':'黄日华'}}))
